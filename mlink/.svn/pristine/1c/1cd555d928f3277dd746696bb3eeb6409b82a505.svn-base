...
// AW API constants
define('API_USERNAME', '274181'); // You affiliate || merchant ID (e.g: 12345)
define('API_PASSWORD', 'cc676b7a8bf39429ee9050a293b7fca9ef8e64bd472771d2'); // You API password (found in your userarea)
...
// PS API constants
define('API_KEY', '40472bc4f561563c47733658b8f9e4e5'); // You API key - Found in your account
