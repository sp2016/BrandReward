...
if(isset($_POST['table']) && !empty($_POST['table'])){
	...
	if ($search['type'] != 'affiliate') {
		$outLogTotal = $objTran->getTransactionRpt($search,$page,$pagesize);
	} else {
		$outLogTotal = $objTran->getTransactionAffRpt($search,$page,$pagesize);
	}
