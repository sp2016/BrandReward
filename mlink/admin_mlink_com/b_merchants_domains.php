...
if (isset($_POST['act']) && $_POST['act'] == 'save')
{
    ...
    $data['Exclusive_Code'] = $_POST['Exclusive_Code'];
    $data['Allow_Inaccurate_Promo'] = $_POST['Allow_Inaccurate_Promo'];
    $data['CPA_Increase'] = $_POST['CPA_Increase'];
    $data['Allow_to_Change_Promotion_TitleOrDescription'] = $_POST['Allow_to_Change_Promotion_TitleOrDescription'];
    $data['Promo_Code_has_been_blacklisted'] = $_POST['Promo_Code_has_been_blacklisted'];
    $data['Word_has_been_blacklisted'] = $_POST['Word_has_been_blacklisted'];
    $data['Coupon_Policy_Others'] = $_POST['Coupon_Policy_Others'];
