...
}(function ($) 
{
	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			var content = ['Year','Month','Day','Hour','Minute'];
			for(iTempIndex = 0; iTempIndex < iNumberOfColumns; iTempIndex++)
			{
				var sFieldName = sArrFields[iTempIndex];
				if(sFieldName == 'day')
					sDTPickerComp += "<div class='dtpicker-compOutline " + sColumnClass + "' style='border-right:#ff0000 solid 2px;'> "+content[iTempIndex];
				else
					sDTPickerComp += "<div class='dtpicker-compOutline " + sColumnClass + "'> "+content[iTempIndex];
		...
		_setCurrentDate: function()
		{
			...
			if(oDTP.oData.bDateMode || oDTP.oData.bDateTimeMode)
			{
				...
				else
				{
					if(oDTP.oData.bDateMode && (oDTP.oData.bArrMatchFormat[4] || oDTP.oData.bArrMatchFormat[5] || oDTP.oData.bArrMatchFormat[6]))
					{
						...
						sDate =oFormattedDate.yyyy + "-" + oFormattedDate.month + "-" + oFormattedDate.dd;
			...
			{
				if(oDTP.oData.bDateTimeMode)
					//sDateTime = oDTP.settings.dateTimeSeparator + sTime;
				sDateTime = sDate + oDTP.settings.dateTimeSeparator + sTime;
				else if(oDTP.oData.bDateMode)
					sDateTime = sDate;
				else if(oDTP.oData.bTimeMode)
