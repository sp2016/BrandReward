...
$steps[0]['url'] = 'http://affiliate.havasmedia.co.uk/public/aLogin.action';
$steps[0]['req'] = 'GET';
...
$steps[1]['url'] = 'http://affiliate.havasmedia.co.uk/pan/login';
$steps[1]['req'] = 'POST';
...
$steps[2]['url'] = 'http://affiliate.havasmedia.co.uk/pan/aReport3.action';
$steps[2]['req'] = 'POST';
...
$steps[2]['dom'] = 'http://affiliate.havasmedia.co.uk/';    
$steps[2]['try'] = 0;
