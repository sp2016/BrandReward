...
define('API_SID_182', 'IRkBxi9XJngC32788C5dEGvh5BXDBbyDi4');
define('API_TOKEN_182', 'TTcALLYkBWDEGTt5Dj8PuhaAJniF2VVP');
define('AFFID_INAFF_182', '11290');

class LinkFeed_182_ImpactRadius_CA
{	
	...
	function GetAllLinksFromAffByMerID($merinfo)
	{
		...
		// coupon by api
		$AccountSid = API_SID_182;
		$AccountToken = API_TOKEN_182;
...
//					print_r($link);
	...
	private function get_linkcode_by_text_182($text)
	{
	...
	function GetProgramByPage()
	{
		...
		while($hasNextPage){
			...
			foreach($data as $v){
				...
				$CommissionExt = trim(strip_tags($this->oLinkFeed->ParseStringBy2Tag($prgm_detail, array('Payment Details', '<p class="uitkBoxHalfLast">'), '</p>', $detail_start)));
	...
	function GetProgramByApi()
	{
		...
		$AccountSid = "IRkBxi9XJngC32788C5dEGvh5BXDBbyDi4";
		$AccountToken = "TTcALLYkBWDEGTt5Dj8PuhaAJniF2VVP";
