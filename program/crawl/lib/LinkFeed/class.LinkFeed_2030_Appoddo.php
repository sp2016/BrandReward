...
class LinkFeed_2030_Appoddo
{
	function __construct($aff_id,$oLinkFeed)
	{
		...
		$this->Affiliate_ID = '1238';
		$this->apikey = '80186ca3b249859de964262f79d23b86841fe409dd0716ba7c7ebf53b8683af2';
		$this->NetworkId ='oppoddo';
	...
	function GetProgramByApi()
	{
		...
		$strUrl = "https://oppoddo.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findAll";
		...
		foreach($result as $item)
		{
			...
			if ($StatusInAff == 'Active' && $Partnership == 'Active') {
				$find_url = "https://oppoddo.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findById&id={$IdInAff}";
				...
				//get AffDefaultUrl
				$default_url = "https://oppoddo.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=generateTrackingLink&offer_id={$IdInAff}";
			...
			//get TargetCountry
			$countries_url = "https://oppoddo.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getTargetCountries&ids[]={$IdInAff}";
			...
			//get CategoryExt
			$category_url = "https://oppoddo.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getCategories&ids[]={$IdInAff}";
			...
			//get LogoUrl
			$LogoUrl_url = "https://oppoddo.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getThumbnail&ids[]={$IdInAff}";
