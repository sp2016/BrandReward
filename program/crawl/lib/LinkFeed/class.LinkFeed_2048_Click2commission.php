<?php
class LinkFeed_2048_Click2commission
{
    function __construct($aff_id,$oLinkFeed)
    {
        ...
        $this->Affiliate_ID = '1944';
        $this->apikey = 'e5be8753bde94ed003a2ae73d44bf4b0cd07618361ecc8aedc09adf941faf937';
        $this->NetworkId ='click2commission';
    ...
    function GetProgramByApi()
    {
        ...
        $strUrl = "https://click2commission.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findAll";
...
//        print_r($apiResponse);exit;
        ...
        foreach($result as $item)
        {
            ...
            if ($StatusInAff == 'Active' && $Partnership == 'Active') {
                $find_url = "https://click2commission.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findById&id={$IdInAff}";
                ...
                //get AffDefaultUrl
                $default_url = "https://click2commission.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=generateTrackingLink&offer_id={$IdInAff}";
            ...
            //get TargetCountry
            $countries_url = "https://click2commission.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getTargetCountries&ids[]={$IdInAff}";
            ...
            //get CategoryExt
//            $category_url = "https://click2commission.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getCategories&ids[]={$IdInAff}";
...
//            }
            ...
            //get LogoUrl
            $LogoUrl_url = "https://click2commission.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getThumbnail&ids[]={$IdInAff}";
