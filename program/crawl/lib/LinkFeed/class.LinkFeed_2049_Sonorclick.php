<?php
class LinkFeed_2049_Sonorclick
{
    function __construct($aff_id,$oLinkFeed)
    {
        ...
        $this->Affiliate_ID = '3176';
        $this->apikey = 'ba2dab8af4ec341f1fe056ac8ee74b123587b19890a9317289bff7d12de74913';
        $this->NetworkId ='sonarclick';
    ...
    function GetProgramByApi()
    {
        ...
        $strUrl = "https://sonarclick.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findAll";
...
//        print_r($apiResponse);exit;
        ...
        foreach($result as $item)
        {
            ...
            if ($StatusInAff == 'Active' && $Partnership == 'Active') {
                $find_url = "https://sonarclick.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findById&id={$IdInAff}";
                ...
                //get AffDefaultUrl
                $default_url = "https://sonarclick.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=generateTrackingLink&offer_id={$IdInAff}";
            ...
            //get TargetCountry
            $countries_url = "https://sonarclick.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getTargetCountries&ids[]={$IdInAff}";
            ...
            //get CategoryExt
            $category_url = "https://sonarclick.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getCategories&ids[]={$IdInAff}";
            ...
            //get LogoUrl
            $LogoUrl_url = "https://sonarclick.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getThumbnail&ids[]={$IdInAff}";
