...
class LinkFeed_2055_Monetise
{
    ...
    function GetProgramFromByPage()
    {
        ...
        $strUrl = "http://mymonetise.co.uk/affiliates/Extjs.ashx?s=contracts";
        $hasNextPage = true;
        $page = 1;
        $arr_prgm = array();
        while($hasNextPage){
            ...
            foreach($result as $item)
            {
                ...
                if($StatusInAffRemark == 'Active')
                {
                    ...
                    $detailDefaulUrl = "http://mymonetise.co.uk/affiliates/Extjs.ashx?s=creatives&cont_id=$contid";
