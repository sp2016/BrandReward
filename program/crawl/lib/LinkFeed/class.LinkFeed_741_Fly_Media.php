...
class LinkFeed_741_Fly_Media
{
    ...
    function GetProgramFromByPage()
    {
        ...
        echo "get program \r\n";
        $strUrl = "http://partners.flymedia.in/affiliates/Extjs.ashx?s=contracts";
        $hasNextPage = true;
        $page = 1;
        $arr_prgm = array();
        while($hasNextPage){
            ...
            foreach($result as $item)
            {
                ...
                {
                    $Partnership = 'Active';
                    $detailUrl = "http://partners.flymedia.in/affiliates/Extjs.ashx?s=contract_info&cont_id=$strMerID";
                    ...
                    $detailDefaulUrl = "http://partners.flymedia.in/affiliates/Extjs.ashx?s=creatives&cont_id=$strMerID";
                    $request = array("AffId" => $this->info["AffId"],"method" => "post", "postdata" => "s=creatives&cont_id=$strMerID", );
