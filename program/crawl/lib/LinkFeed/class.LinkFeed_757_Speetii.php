...
class LinkFeed_757_speetii
{
    ...
    function GetProgramFromByPage()
    {
        ...
        echo "get program \r\n";
        $strUrl = "http://login.speetii.com/affiliates/Extjs.ashx?s=contracts";
        $hasNextPage = true;
        $page = 1;
        $arr_prgm = array();
        while($hasNextPage){
            ...
            foreach($result as $item)
            {
                ...
                {
                    $Partnership = 'Active';
                    $detailUrl = "http://login.speetii.com/affiliates/Extjs.ashx?s=contract_info&cont_id=$strMerID";
                    ...
                    $detailDefaulUrl = "http://login.speetii.com/affiliates/Extjs.ashx?s=creatives&cont_id=$strMerID";
