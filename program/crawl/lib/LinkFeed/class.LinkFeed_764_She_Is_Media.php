<?php
class LinkFeed_764_She_Is_Media
{
    function __construct($aff_id,$oLinkFeed)
    {
        ...
        $this->Affiliate_ID = '2888';
        $this->apikey = '6244e6a6188aaaf59978622ee375ff0b59454123c2824d6c944d6486f848d352';
        $this->NetworkId ='sheismedia';
    ...
    function GetProgramByApi()
    {
        ...
        $strUrl = "https://sheismedia.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findAll";
...
//        print_r($apiResponse);exit;
        ...
        foreach($result as $item)
        {
            ...
            if ($StatusInAff == 'Active' && $Partnership == 'Active'){
                $find_url = "https://sheismedia.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=findById&id={$IdInAff}";
            ...
            if ($Partnership == 'Active') {
                //get AffDefaultUrl
                $default_url = "https://sheismedia.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=generateTrackingLink&offer_id={$IdInAff}";
            ...
            //get TargetCountry
            $countries_url = "https://sheismedia.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getTargetCountries&ids[]={$IdInAff}";
            ...
            //get CategoryExt
            $category_url = "https://sheismedia.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getCategories&ids[]={$IdInAff}";
            ...
            sleep(rand(1,5));
            //get LogoUrl
            $LogoUrl_url = "https://sheismedia.api.hasoffers.com/Apiv3/json?api_key={$this->apikey}&Target=Affiliate_Offer&Method=getThumbnail&ids[]={$IdInAff}";
