...
class LinkFeed_818_Actionpay
{
    ...
    function GetProgramByApi()
    {
        ...
        //Get all programs whose have partnership with MEIKAI
        $avilableArr = array();
    ...
    function getCouponFeed()
    {
        ...
        $strUrl = 'https://actionpay.net/ru-en/couponFeed/xmlFilter/id:6045';
        echo $strUrl.PHP_EOL;
        $result = $this->GetHttpResult($strUrl,$request, '', 'couponfeed_6045');
