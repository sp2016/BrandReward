...
foreach($affiliate_list as $affid => $aff_v){
	...
	while(true){
		$where_str = "";
		$sql = "select a.ID, a.Name, a.CommissionExt, a.AffId,a.CategoryExt,a.IdInAff, a.Homepage, a.Description, a.StatusInAff, a.Partnership, a.AffDefaultUrl, a.SupportDeepUrl, a.CommissionExt, a.TargetCountryExt, a.TargetCountryInt, a.TargetCountryIntOld, a.LastUpdateTime, b.HomepageInt,
				c.ShippingCountry,a.PublisherPolicy, a.SecondIdInAff
